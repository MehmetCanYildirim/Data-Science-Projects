...
def load_telco():
    df = pd.read_csv(r"Ödevler/Ödevler/Telco-Customer-Churn.csv")
    return df
...
# Verisetinde Numerik ama object olarak gözüken değişkenin içerisine girip bir bakmak gerekti.
df[df["TotalCharges"] == " "]
...
# Kategorik ve Sayısal Değişkenleri Gözlemleyelim.
...
cat_cols = [col for col in cat_cols if col not in ['Churn','NEW_TotalServices']]
cat_cols
